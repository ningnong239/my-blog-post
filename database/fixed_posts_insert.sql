-- Fixed posts insert without author_id column
-- Run this in Supabase SQL Editor

-- Insert sample posts using existing categories and statuses
WITH publish_status AS (
...
-- Insert sample comments using existing users
WITH post_ids AS (
...
-- Insert sample likes using existing users
WITH post_ids AS (
    SELECT id FROM posts LIMIT 3
),
random_users AS (
