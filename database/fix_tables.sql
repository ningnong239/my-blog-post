-- Fix empty tables and add sample data
...
INSERT INTO profile (id, name, bio, avatar_url, role, username, email)
SELECT 
    au.id,
    'Admin User' as name,
...
INSERT INTO posts (title, description, content, image, category_id, author_id, likes_count, status_id, date)
SELECT 
    post_data.title,
